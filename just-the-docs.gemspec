...
Gem::Specification.new do |spec|
  ...
  spec.summary       = %q{개발 초점연되고 미리 커스터마이징되고 반응형으로 디자인된, 기본 검색 기능이 내장된 Jekyll 테마.}
  ...
  spec.files         = `git ls-files -z`.split("\x0").select { |f| f.match(%r{^(assets|bin|_layouts|_includes|lib|Rakefile|_sass|LICENSE|README|CHANGELOG|favicon)}i) && !f.match(%r{\.(jpg|png)$}i) }
